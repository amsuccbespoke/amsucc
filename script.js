...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const products = [
    { name: 'Classic Agbada', code: 'FL-AGB-001', url: 'agbada.html' },
    { name: 'Royal Agbada', code: 'FL-AGB-002', url: 'agbada.html' },
    { name: 'Embroidered Agbada', code: 'FL-AGB-003', url: 'agbada.html' },
    { name: 'Luxury Agbada', code: 'FL-AGB-004', url: 'agbada.html' },
    { name: 'Premium Agbada', code: 'FL-AGB-005', url: 'agbada.html' },
    { name: 'Classic Kaftan', code: 'FL-KAF-001', url: 'kaftan.html' },
    { name: 'Royal Kaftan', code: 'FL-KAF-002', url: 'kaftan.html' },
    { name: 'Embroidered Kaftan', code: 'FL-KAF-003', url: 'kaftan.html' },
    { name: 'Luxury Kaftan', code: 'FL-KAF-004', url: 'kaftan.html' },
    { name: 'Premium Kaftan', code: 'FL-KAF-005', url: 'kaftan.html' },
    { name: 'Corporate Shirt & Trouser', code: 'FL-CV-001', url: 'cv.html' },
    { name: 'Vintage Shirt', code: 'FL-CV-002', url: 'cv.html' },
    { name: 'Premium Trouser', code: 'FL-CV-003', url: 'cv.html' },
    { name: 'Gallery', code: '', url: 'gallery.html' },
    { name: 'Contact', code: '', url: 'contact.html' },
  ];
  ...
  function performSearch(query) {
    ...
    if (results.length === 0) {
      searchResults.innerHTML = `
        <div class="search-no-results">
          ...
          <small>Try searching for agbada, kaftan, or shirts</small>
        </div>
      `;
      return;
    }
    ...
    searchResults.innerHTML = results.map(p => `
      <a href="${p.url}" class="search-result-item" onclick="closeSearch()">
        <div class="search-result-info">
          <span class="search-result-name">${p.name}</span>
          ${p.code ? `<span class="search-result-code">${p.code}</span>` : ''}
        </div>
